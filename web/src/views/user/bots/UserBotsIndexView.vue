            ...
            <div class="col-10">
                <div class="card" style="margin-top: 20px;">
                    <div class="card-header">
                        ...
                        <div class="modal fade" id="add-bot-btn" tabindex="-1"><!--创建bot的悬浮表单-->
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <div class="error-message">{{submit_error_message}}</div>
                            ...
                            <tbody>
                                <tr v-for="bot in bots" :key="bot.id">
                                    ...
                                    <td>
                                        ...
                                        <div class="modal" id="remove-bot-btn" tabindex="-1"><!--删除的二次警告框-->
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">删除警告</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-primary"
                                                            @click="remove_bot(bot)">确定删除</button>
                                                        <button type="button" class="btn btn-secondary"
                                                            data-bs-dismiss="modal">取消</button>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const submit_error_message = ref("");
            ...
            refresh_bots();
            const add_bot = function () {
                submit_error_message.value = "";
                $.ajax({
                    url: "https://app6679.acapp.acwing.com.cn/api/user/bot/add/",
                    type: "post",
                    data: {
                        title: botadd.title,
                    ...
                    success(resp) {
                        if (resp.error_message === "success") {
                            ...
                            submit_error_message.value = resp.error_message;
                        }
                    },
                })
            }
            const remove_bot = function (bot) {
                $.ajax({
                    url: "https://app6679.acapp.acwing.com.cn/api/user/bot/remove/",
                    type: "post",
                    data: {
                        bot_id: bot.id,
                    },
            ...
            const update_bot = function (bot) {
                submit_error_message.value = "";
                $.ajax({
                    url: "https://app6679.acapp.acwing.com.cn/api/user/bot/update/",
                    type: "post",
                    data: {
                        bot_id: bot.id,
                        title: bot.title,
